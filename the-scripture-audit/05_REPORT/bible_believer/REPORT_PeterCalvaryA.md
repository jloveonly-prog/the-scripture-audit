...
sequenceDiagram
    ...
    J->>P: Girds himself and washes feet [ζώννυμι gird] (13:4)
    P->>J: Wash not only feet, but hands and head [πόδας feet + χεῖρας hands + κεφαλήν head] (13:9)
    J->>P: Knowest not now, but shalt know hereafter [μετὰ ταῦτα hereafter] (13:7)
    J->>P: If I wash thee not, thou hast no part with me [part participate] (13:8)
    J->>P: Cannot follow now, but shalt follow afterwards [ὕστερον afterwards] (13:36)
    end

    rect rgb(245, 210, 210)
    Note over J,C: ⛪ John 19 — The Cross of Jesus
    J->>C: Led away [ἀπάγω short-distance escort] → Arrives at Golgotha (19:16-17)
    Note over J,C: Fulfillment of what death he should die [σημαίνων ποίῳ θανάτῳ what death] (12:33)
    Note over J,C: Goes though not willing [θέλω will] (Matt 26:39)
    Note over J,C: He who girded himself bears the cross [gird → cross]
    end

    rect rgb(210, 240, 220)
    Note over J,P: 📖 John 21 — The Sea of Galilee after Resurrection
    J->>P: Simon, son of Jonas [Barjona mission mark] × 3 times (21:15-17)
    J->>P: When old, shalt stretch forth thy hands [χεῖρας hands — same word as 13:9] (21:18)
    ...
    Note over P: By what death he should glorify God [σημαίνων ποίῳ θανάτῳ δοξάσει / what death...glorify God] (21:19)
    J->>P: Follow me [ἀκολούθει μοι / Follow me] (21:19)
    J->>P: Never mind John, what is that to thee? follow thou me [σύ μοι ἀκολούθει / thou follow me] (21:22)
    end

    rect rgb(245, 235, 210)
    Note over P: 📖 1 Peter 5:13 — Babylon Ministry Period
    P->>P: Timeline Guard in operation — God's preservation until old age
    P->>P: Writing epistle in Babylon — φέρω starting point confirmed
    Note over P: Acts 12:8 Angel: gird thyself(ζῶσαι) → Not the time yet → Released
    end

    rect rgb(245, 220, 220)
    Note over P,C: ⛪ Fulfillment of Prophecy — Peter's Calvary Martyrdom
    P->>C: Carried [φέρω carry] — Babylon→Calvary long-distance travel
    Note over P,C: Goes though not willing [θέλω will] — Same as Jesus
    Note over P,C: Another girds him [ζώννυμι gird] — Same root as Jesus
    Note over P,C: What death to glorify [what death...glorify] — Same formula as Jesus
    Note over P,C: "Follow me" completed [ἀκολούθει follow] — Joining the cross at Calvary
    end
```
