...
graph TD
    ...
    Start(["John 6 Interpretation Audit"]) --> Define["① Jesus' prior definition (John 6:35)<br>• Coming = Eating<br>• Believing = Drinking"]
    Define --> CoreVerse[" Core Verse (John 6:53)<br>'Unless you eat the flesh(σάρξ)... you have no life'"]
    
    CoreVerse --> Branch{Branches of Interpretation}
    
    %% Catholic Transubstantiation Route
    Branch -->|"Transubstantiation (Physical Interpretation)"| CatholicRoute["②-A. Must eat the physical flesh(σάρξ) directly"]
    CatholicRoute --> Catholic63["Apply John 6:63<br>'The flesh(σάρξ) counts for nothing'"]
    Catholic63 --> CatholicClash{"Logic Collision (Self-contradiction)<br>Must eat flesh(σάρξ) for eternal life(profit) vs flesh(σάρξ) counts for nothing"}
    CatholicClash -->|"Contradiction Occurs"| CatholicFail[/"Collapse of Transubstantiation Interpretation"/]:::warning
    
    %% Biblical Spiritual Interpretation Route
    Branch -->|"Biblical Interpretation (Jesus' own explanation)"| BibleRoute["②-B. Eating flesh(σάρξ) = Believing and accepting Jesus"]
    BibleRoute --> Bible63["Apply John 6:63<br>'The flesh(act of chewing physical meat) counts for nothing;<br>the words I have spoken are spirit and life'"]
    Bible63 --> BibleHarmonize{"Logical Harmony<br>The act of eating physical meat counts for nothing,<br>believing and accepting Jesus' word(spirit) is true eternal life"}
    BibleHarmonize -->|"Harmony/Resolution"| BibleSuccess[/"Establishment of Biblical Spiritual Interpretation"/]:::success
```
