...
```mermaid
flowchart TD
    Q["❓ Core Question\nBaby died with infant baptism\nbut no confirmation·communion·penance\n→ Do they go to heaven?"]

    Q -->|YES — Goes to heaven| A["✅ Choose A"]
    Q -->|NO — Cannot go / Uncertain| B["❌ Choose B"]
    Q -.->|Attempt 3rd escape route| L["🔴 Limbo"]

    A --> A1["Heaven without 6 sacraments\n→ Collapse of the 7 sacraments essential system ❌"]
    A --> A2["Baby 1 stage vs Adult 5+ stages\n→ Reverse discrimination structure of salvation ❌"]
    A --> A3["John 6:53 'no life if you don't eat flesh'\nException for babies?\n→ Collapse of bible verse universality ❌"]
    A --> A4["Acts 8:37 'If you believe with all your heart'\nBabies cannot believe\n→ No biblical basis for infant baptism ❌"]

    B --> B1["Baptism removed original sin\nbut cannot go to heaven → Baptism effect meaningless ❌"]
    B --> B2["Demanding impossible sacraments\n→ Collapse of God's justice ❌"]

    L --> L1["Retracted by the Vatican itself in 2007\n→ Previous popes were wrong\n→ Collapse of Papal Infallibility ❌"]

    A1 & A2 & A3 & A4 --> V
    B1 & B2 --> V
    L1 --> V
    V["⚖️ VERDICT\nCONTRADICTION IRONCLAD — CASCADE\nEntire 7 Sacraments System Chain Collapse"]
...
sequenceDiagram
    autonumber
    participant A as Biblical Apologist
    participant C as Catholic Respondent

    A->>C: "Baby died with infant baptism but no confirmation·communion·penance—<br/>Do they go to heaven?"

    alt YES Choice Path
        C-->>A: "Yes, they go to heaven"
        A->>C: "John 6:53 — No life if you don't eat the flesh.\nIs this verse an exception for babies?"
        C-->>A: "...(Silence or admits exception)"
        A->>C: "If baptism alone is heaven, why are the remaining 6 sacraments\n'essential for salvation'?"
        C-->>A: "...(Collapse of 7 sacraments necessity)"
    else NO Choice Path
        C-->>A: "Uncertain / Entrust to God's mercy"
        A->>C: "Then since baptism removed original sin,\nwhy is heaven uncertain?"
        C-->>A: "...(Admitting weakening of baptism efficacy)"
        A->>C: "Is God just if a baby cannot go to heaven\nbecause of a sacrament they couldn't choose?"
    end

    A->>C: "Did you try to solve it with Limbo?\nThe Vatican itself retracted Limbo in 2007."
    C-->>A: "..."
    A->>C: "If the popes who taught Limbo for hundreds of years were wrong,\nwhat happens to Papal Infallibility?"

    Note over A,C: Finalizing with Acts 8:37
    A->>C: "What Philip demanded before baptism = 'believing with the heart' (Acts 8:37)\nCan a baby believe with their heart?"
    C-->>A: "Through the parents' faith..."
    A->>C: "'Baptizing children through parents' faith' — Where is it in the Bible?\nPlease provide the verse."
    C-->>A: "⚖️ No logical escape route"
```
