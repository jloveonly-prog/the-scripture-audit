...
```mermaid
graph TD
    subgraph ETERNITY["Era of Eternity — No Days"]
        E1["Job 38:7 Creation of sons of God"]
        E2["Sons form nations from dust"]
        E3["Isa 14:12 Satan's fall — contamination of nations"]
        E3b["2 Pet 2:4 Angels commit lawlessness with nations — imprisonment in Tartarus"]
        E4["Gen 1:2 First world judgment — bodies of nations destroyed"]
        E1 --> E2 --> E3 --> E3b --> E4
    end

    subgraph SIXDAYS["6 Days — Time Begins"]
        D1["Gen 1:3 Separation of light and darkness — First day"]
        D2["Gen 2:7 Creation of Adam"]
        D3["Gen 2:22 Creation of Woman"]
        D1 --> D2 --> D3
    end

    subgraph HISTORY["Historical Era"]
        H1["Matt 12:43 Devils wander in dry places"]
        H2["Gen 6:2 Sons of Adam take daughters of men"]
        H4["Gen 6:4 Emergence of Nephilim"]
        H5["Gen 7:11 Noah's Flood"]
        H1 --> H2 --> H4 --> H5
    end

    subgraph NTCHURCH["New Testament ~ Church Age"]
        N1["Mark 5:9 Legion — Division and fusion of devils"]
        N2["Eph 6:12 Powers of the air — Satan's angels+powers+principalities"]
        N3["1 Pet 5:8 Satan prowls around"]
        N1 --> N2 --> N3
    end

    subgraph FUTURE["Future — Revelation"]
