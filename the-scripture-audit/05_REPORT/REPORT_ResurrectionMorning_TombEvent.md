...
sequenceDiagram
    ...
    Magdalene->>+Tomb: Depart & Arrive
    Women->>+Tomb: Depart & Arrive

    Note over Tomb: T1-A — Angel of the Lord (lightning face) rolls stone (Matt 28:2)
    Note over Tomb: T1-B — 2 inside angels: Appear standing → Speak sitting (Mark 16:5, Luke 24:4)

    Magdalene-->>Peter: T1-C: "WE know not" Suspected theft report (John 20:2)
    Magdalene-->>John: (Simultaneous report)
    Women-->>Women: Shock, flight, silence (Mark 16:8)

    Peter->>+Tomb: T2: Runs to tomb (John 20:3-10)
    John->>+Tomb: (Runs together, arrives first)
    Peter-->>Peter: Checks linen clothes, goes home
    John-->>John: Sees and believes, goes home

    Magdalene->>+Tomb: T3: Returns alone, stands weeping
    Jesus->>Magdalene: ★ First Appearance "Mary!" (John 20:14, Mark 16:9)
    Magdalene-->>Magdalene: Tells disciples "I have seen the Lord"

    Jesus->>Women: ★ Second Appearance "All hail" (Matt 28:9)

    Note over Jesus,Women: T5 — Guards bribery incident (Matt 28:11-15)
    Note over Jesus,Women: T6 — Third Appearance to Emmaus two disciples (Luke 24:15)
    Note over Jesus,Women: T7 Evening — Fourth Appearance to eleven disciples in upper room (John 20:19)
    Note over Jesus,Women: T8 8 days later — Fifth Appearance including Thomas (John 20:26)
```
